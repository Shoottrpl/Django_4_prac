...
urlpatterns = [
    ...
    path('password-change/done/', PasswordChangeDoneView.as_view(template_name='users/password_change_done.html', title='Пароль успешно изменен'), name='password_change_done'),
